...
foreach ($recipients as $value) {
		$query = "insert into class_general (general_message, general_file, to_id, from_id, opened, recipient_delete, sender_delete, time_sent, class_id, general_code,general_cat) values ('$message','$msg_file','$value','$from_id','0','0','0', NOW(),'$class_id','$general_code','reminder')";
