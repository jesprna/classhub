...
<div class="content" >
	...
	<?php
$msg_query = "select general_message,to_id,from_id,general_file,general_reply,general_id,time_sent,sender_delete,general_code,opened,general_cat  from class_general where (class_id = '{$_SESSION['current_class']}' and from_id ='{$_SESSION['current_member']}' and sender_delete='0' and general_cat='homework') or (class_id = '{$_SESSION['current_class']}' and to_id ='{$_SESSION['current_member']}' and recipient_delete='0' and general_cat='homework' ) group by general_message  order by general_id  desc ";
  ...
  <form action='index.php' method='post' enctype='multipart/form-data'>
   ...
   if ($opened==0){
        $style = "style='background-color:rgb(30, 138, 23);'";
            ...
            <img class='msglogo' src='../images/homework.png'>
